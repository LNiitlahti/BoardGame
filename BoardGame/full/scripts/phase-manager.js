...
const PHASE_DISPLAY = {
    ...
    spell_window_1:   { name: 'Spell Window 1',       icon: ICON_SVGS.sparkles },
    hex_placement_2:  { name: 'Hex Placement — Game 2', icon: ICON_SVGS.map },
    challenges:       { name: 'Challenges Issued',    icon: ICON_SVGS.swords },
    spell_window_2:   { name: 'Spell Window 2',       icon: ICON_SVGS.sparkles },
    challenge_game:   { name: 'Challenge Game',       icon: ICON_SVGS.gamepad2 },
    spell_window_3:   { name: 'Spell Window 3',       icon: ICON_SVGS.sparkles },
    board_resolved:   { name: 'Board Resolved',       icon: ICON_SVGS.shield },
    spell_window_4:   { name: 'Spell Window 4',       icon: ICON_SVGS.sparkles },
